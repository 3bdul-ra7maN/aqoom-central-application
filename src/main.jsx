...
function App(){
  ...
  const progress=useMemo(()=>[task,execution,trace?.result,trace?.evidence?.some(v=>v.status==="VALIDATED"),trace?.rt,trace?.settlement].filter(Boolean).length,[task,execution,trace]);
